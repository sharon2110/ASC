        ...
        <section class="navbar aside">
            ...
            <div class="container-fluid">
                <ul class="opciones">
                    ...
                    <li>
                        <a href="listaTramites.php" style="font-size:medium;"><i class="fas fa-clipboard-list fa-fw"></i>&nbsp;LISTA TRÁMITES
                        </a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                ...
                <form action="" class="formularioActualizaT" id="ac_reg_tramite" autocomplete="off" method="POST" enctype="multipart/form-data">
                    <fieldset>
                        <legend style="font-size:larger;"><i class="fas fa-user-plus"></i> &nbsp; Actualizar Trámite</legend>
                        <div class="container-fluid">
                            <div class="row" style="text-align:center;">
                                <input type="text" name="id" id="id_tramite" maxlength="16" value="<?php echo base64_decode($proceso)?>" hidden >
                                <div class="col-12 col-md-2">
                                    <br>
                                    <button class="btn btn-danger fa-sm" data-bs-toggle="modal"
                                        data-bs-target="#modalCliente" type="button" name="btnAdCliente"
                                        id="idbtnAdCliente"
                                        style="width:55%; padding:7px;margin-bottom:10px;" hidden> <i
                            ...
                            <div class="row datosBanco">
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="banco" id="info_banco" maxlength="6" disabled style="font-size:14px;">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="estado" class="form-select" id="estado_selec" required style="font-size:14px;">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required name="asesor_credito" id="asesor_credito_id" style="font-size:14px;">
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="moneda" class="bmd-label-floating titulo">Sucursal</label>
                                        <input type="text" class="form-control" required name="sucursal_banco" id="sucursal_banco_id" style="font-size:14px;">
                                    </div>
                                </div>
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="moneda" class="bmd-label-floating titulo">Observación</label>
                                        <input type="text" class="form-control" required name="observacion" id="observacion_id" style="font-size:14px;">
                                    </div>
                                </div>
                            ...
                            <div class="justify-content-center table-responsive" style="padding:10px;">
                                <table class="table tablaOpciones">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-center"><button class="btn btn-danger botonOpciones" type="button" data-bs-toggle="modal" data-bs-target="#modalV"><i class="fas fa-car fa-xs"></i></button></td>
                            ...
                            <div class="modal fade" id="modalVadd" tabindex="-1" aria-labelledby="modelTitleId"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-12" style="background-color:brown; color:white; margin:10px;font-size:15px; padding:8px;">
                                            ...
                                            <div class="modal-body">
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGCarnet">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGFacLuz">Quitar</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGFacAgua">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGCroquis">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGFolio">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGTestimonio">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGImpuesto">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGRuat">Quitar</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGSoat">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGNit">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGPatente">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGBoletaPago">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="margin:30px;width:200px;">
                                                        ...
                                                        <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGAfp">Quitar</button>
                                                    </div>
                                                    <div class="col-12" style="background-color:brown; margin:10px;color:white; font-size:16px; padding:8px; ">Deudas Con Otros Bancos</div>
                                                    <div class="col-12 col-md-8">
                                                        <div class="form-group">
                                                            <label for="nom_banco" class="bmd-label-floating titulo">Banco</label>
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-12" style="margin:30px;width:200px;">
                                                            ...
                                                            <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGPlanPago1">Quitar</button>
                                                        </div>
                                                        <div class="col-12" style="margin:30px;width:200px;">
                                                            ...
                                                            <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGBoletaCancelacion1">Quitar</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-8">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-12" style="margin:30px;width:200px;">
                                                            ...
                                                            <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGPlanPago2">Quitar</button>
                                                        </div>
                                                        <div class="col-12" style="margin:30px;width:200px;">
                                                            ...
                                                            <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGBoletaCancelacion2">Quitar</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-8">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-12" style="margin:30px;width:200px;">
                                                            ...
                                                            <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGPlanPago3">Quitar</button>
                                                        </div>
                                                        <div class="col-12" style="margin:30px;width:200px;">
                                                            ...
                                                            <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGBoletaCancelacion3">Quitar</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-8">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-12" style="margin:30px;width:200px;">
                                                            ...
                                                            <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGPlanPago4">Quitar</button>
                                                        </div>
                                                        <div class="col-12" style="margin:30px;width:200px;">
                                                            ...
                                                            <button type="button" class="col-2 btn btn-danger center-block" style="display:inline-block; position:absolute; height:30px; margin-left:30px; padding:2px;" id="quitaGBoletaCancelacion4">Quitar</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="modal fade listaDoc" id="modalCLis" tabindex="-1" aria-labelledby="modelTitleId" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" style="font-size:16px;">Lista de Documentos Entregados - Cliente</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body" style="margin-top: 20px;">
                                                <div class="row">
                                                    ...
                                                    <br>
                                                    <!-- TABLA DEUDAS-->
                                                    <div class="col-12" style="background-color:brown; color:white; font-size:16px; padding:8px;">Deudas con otros bancos</div>
                                                    <br>
                                                        ...
                                                        <table class="table table-sm tabla">
                                                            ...
                                                            <tbody>
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group col-10">
                                                                            <select class="form-select" aria-label="Default select example" name="selec_deuda_lcliente1" id="bancod1" style="font-size:15px;">
                                                                                <option value="0">Seleccionar</option>
                                                                                <?php
                                                                                require_once '../scripts/conexion.php';
                                                                                $sentencia = $con->prepare("SELECT * from banco order by banco;");
                                                                ...
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group col-10">
                                                                            <select class="form-select" aria-label="Default select example" name="selec_deuda_lcliente2" id="bancod2" style="font-size:15px;">
                                                                                <option value="0">Seleccionar</option>
                                                                                <?php
                                                                                require_once '../scripts/conexion.php';
                                                                                $sentencia = $con->prepare("SELECT * from banco order by banco;");
                                                                ...
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group col-10">
                                                                            <select class="form-select" aria-label="Default select example" name="selec_deuda_lcliente3" id="bancod3" style="font-size:15px;">
                                                                                <option value="0">Seleccionar</option>
                                                                                <?php
                                                                                require_once '../scripts/conexion.php';
                                                                                $sentencia = $con->prepare("SELECT * from banco order by banco;");
                                                                ...
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group col-10">
                                                                            <select class="form-select" aria-label="Default select example" name="selec_deuda_lcliente4" id="bancod4" style="font-size:15px;">
                                                                                <option value="0">Seleccionar</option>
                                                                                <?php
                                                                                require_once '../scripts/conexion.php';
                                                                                $sentencia = $con->prepare("SELECT * from banco order by banco;");
                                ...
                                <div class="modal fade listaDoc" id="modalGLis" tabindex="-1" aria-labelledby="modelTitleId" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" style="font-size:16px;">Lista de Documentos Entregados - Garante</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body" style="margin-top: 20px;">
                                                <div class="row">
                                                    ...
                                                    <br>
                                                    <!-- TABLA DEUDAS-->
                                                    <div class="col-12" style="background-color:brown; color:white; font-size:17px; padding:8px;">Deudas con otros bancos</div>
                                                    <br>
                            ...
                            <p class="text-center" style="margin-top: 20px;">
                                <button type="button"  id="boton_guardar_id" class="btn btn-success" style="padding:7px;font-size:14px;"><i class="far fa-save"></i> &nbsp;
                                    GUARDAR</button>
                            </p>
                        </div>
                    </fieldset>
